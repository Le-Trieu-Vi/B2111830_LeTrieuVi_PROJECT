		...
		<div class="modal-mask modal">
			...
			<div class="modal-dialog " role="document">
				...
				<div class="modal-header">
					...
					<button type="button" @click="$emit('hideProductAddModal')" class="close rounded-3" data-dismiss="modal" aria-label="Close">
				...
				<div class="modal-footer">
					<button type="button" @click="addProduct" class="close-btn btn btn-secondary custom-btn-primary">Thêm</button>
					<button type="button" @click="$emit('hideProductAddModal')" class="close-btn btn btn-secondary custom-btn-primary" data-dismiss="modal">Đóng</button>
				</div>
				</div>
			</div>
			</div>
...
export default {
	...
	emits: ['reloadProducts', 'hideProductAddModal'],
	data() {
		return {
			product: {}
		}
