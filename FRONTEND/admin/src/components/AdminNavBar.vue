<template>
	<nav class="my-nav sticky-top navbar navbar-expand-lg">
		<div v-if="!user" class="ms-5 container">
			<!-- logo begin -->
			<router-link to="/admin/login" class="navbar-brand mt-2 mt-lg-0">
				<img src="@/assets/logo.png" height="100" loading="lazy" />
			</router-link>
			<h2>Trang quản lý bán hàng của FreshDrink</h2>
			<!-- logo end -->
		</div>
		<div v-else class="ms-5 me-5 container-fluid">
			<!-- logo begin -->
			<router-link to="/admin" class="navbar-brand mt-2 mt-lg-0">
				<img src="@/assets/logo.png" height="100" loading="lazy" />
			</router-link>
			<!-- logo end -->
			...
			<div class="collapse navbar-collapse ms-5" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<!-- admin page -->
					<li class="nav-item">
						<router-link to="/admin/dashboard" :class="navLinkClass1">Trang chủ</router-link>
					</li>
					<li class="nav-item">
