		...
		<div class="card card-stepper text-black" style="border-radius: 16px;">
			...
			<div class="card-body p-5">
				<div class="d-flex justify-content-between align-items-center mb-5">
					<div class="d-flex">
						<img src="https://cdn0.iconfinder.com/data/icons/party-colored/512/order-64.png" class="me-2"
							height="40" />
						<h5 class="mb-0 fs-3">Đơn &nbsp;<span class="fw-bold" style="color: var(--coral)">{{ order._id
						}}</span></h5>
					</div>
					<div class="text-end">
				...
				<div class="">
					...
					<div>
						<ProductsListItemModal v-for="product in order.cartItems" :key="product.productDetail._id"
